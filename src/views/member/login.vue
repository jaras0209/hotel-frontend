        ...
        <div class="row justify-content-md-center">
            <div class="col-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="exampleInputPassword1" name="pwd" v-model="password" placeholder="請輸入密碼" autocomplete>
                </div>
                ...
                <div class="d-flex justify-content-evenly">
                    ...
                    <div class="p-3 mb-2 bg-success-subtle text-success-emphasis rounded"><RouterLink class="nav-link" to="/member/register">註冊</RouterLink></div>
                </div>
